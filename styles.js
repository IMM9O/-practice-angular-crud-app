...
// Module
exports.push([module.i, ":root {\n  --text-color: #3e434f;\n  --text-secondary: #616473;\n  --text-muted: #bdc0ca;\n  --bg-color: #f0efe9;\n}\n\n/* Rest Part */\n\n*,\n*::before,\n*::after {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n}\n\n[hidden] {\n  display: none !important;\n}\n\n/** HTML Page layout **/\n\nhtml,\nbody {\n  height: 100%;\n  width: 100%;\n}\n\nbody {\n  font-family: -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, Oxygen, Ubuntu, Cantarell, \"Open Sans\", \"Helvetica Neue\", sans-serif;\n  display: flex;\n  justify-content: center;\n  color: var(--text-color);\n  background-color: var(--bg-color);\n}\n\n/* Small devices (landscape phones, 576px and up) */\n\n@media (min-width: 320px) {\n  body {\n    font-size: 10px;\n  }\n}\n\n/* Medium devices (tablets, 768px and up) The navbar toggle appears at this breakpoint */\n\n@media (min-width: 768px) {\n  body {\n    font-size: 20px;\n  }\n}\n\n/* Large devices (desktops, 992px and up) */\n\n@media (min-width: 992px) {\n  body {\n    font-size: 18px;\n  }\n}", "",{"version":3,"sources":["styles.scss"],"names":[],"mappings":"AAAA;EACE,qBAAA;EACA,yBAAA;EACA,qBAAA;EACA,mBAAA;AACF;;AAEA,cAAA;;AACA;;;EAGE,SAAA;EACA,UAAA;EACA,sBAAA;AACF;;AAGA;EACE,wBAAA;AAAF;;AAGA,uBAAA;;AACA;;EAEE,YAAA;EACA,WAAA;AAAF;;AAGA;EACE,wIAAA;EAEA,aAAA;EACA,uBAAA;EACA,wBAAA;EACA,iCAAA;AADF;;AAIA,mDAAA;;AACA;EACE;IACE,eAAA;EADF;AACF;;AAGA,wFAAA;;AACA;EACE;IACE,eAAA;EADF;AACF;;AAIA,2CAAA;;AACA;EACE;IACE,eAAA;EAFF;AACF","file":"styles.scss","sourcesContent":[":root {\n  --text-color: #3e434f;\n  --text-secondary: #616473;\n  --text-muted: #bdc0ca;\n  --bg-color: #f0efe9;\n}\n\n/* Rest Part */\n*,\n*::before,\n*::after {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n}\n\n// Need to add !important flag in case of display: flex\n[hidden] {\n  display: none !important;\n}\n\n/** HTML Page layout **/\nhtml,\nbody {\n  height: 100%;\n  width: 100%;\n}\n\nbody {\n  font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen,\n    Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;\n  display: flex;\n  justify-content: center;\n  color: var(--text-color);\n  background-color: var(--bg-color);\n}\n\n/* Small devices (landscape phones, 576px and up) */\n@media (min-width: 320px) {\n  body {\n    font-size: 10px;\n  }\n}\n/* Medium devices (tablets, 768px and up) The navbar toggle appears at this breakpoint */\n@media (min-width: 768px) {\n  body {\n    font-size: 20px;\n  }\n}\n\n/* Large devices (desktops, 992px and up) */\n@media (min-width: 992px) {\n  body {\n    font-size: 18px;\n  }\n}\n"]}]);
// Exports
